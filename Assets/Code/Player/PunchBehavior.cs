...
public class PunchBehavior : StateMachineBehaviour
{
    ...
    public PlayerMovementWithRigidbody.PunchType m_PunchType;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        m_MarioController.SetPunchActiveType(m_PunchType, true);
        m_PunchActive = true;
    }
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            m_MarioController.SetPunchActiveType(m_PunchType, false);
            m_PunchActive = false;
        }
    }
    ...
    {
        m_MarioController.SetPunchActiveType(m_PunchType, false);
        m_MarioController.SetPunchActvie(false);
    }
